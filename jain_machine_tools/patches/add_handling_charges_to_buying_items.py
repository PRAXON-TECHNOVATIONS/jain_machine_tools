...
def execute():
	"""
	Add handling charges custom fields to all buying item doctypes:
	- Purchase Order Item
	...
	5. base_rate_before_handling_charges - Currency field (hidden)
	6. handling_charges_value - Currency field (read-only, for print)
	"""
	...
	# Create fields for each doctype - exact match with Quotation Item structure
	...
	print("Successfully added handling charges fields to all buying item doctypes")
